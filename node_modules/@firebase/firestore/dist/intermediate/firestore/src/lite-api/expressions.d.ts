...
import { JsonProtoSerializer, ProtoValueSerializable } from '../remote/serializer';
...
export declare class Field extends Expression implements Selectable {
     ...
     * @param fieldPath
     */
    constructor(fieldPath: InternalFieldPath, _methodName: string | undefined);
...
export declare function _field(nameOrPath: string | FieldPath, methodName: string | undefined): Field;
/**
 * @internal
 *
 ...
 * @returns A new `Constant` instance.
 */
export declare function constant(value: ProtoValue): Expression;
/**
 * @beta
 ...
 * @param methodName
 */
export declare function _constant(value: unknown, methodName: string | undefined): Constant | BooleanExpression;
/**
 * Internal only
 * @internal
 * @private
 */
export declare class MapValue extends Expression {
    private plainObject;
    readonly _methodName: string | undefined;
    constructor(plainObject: Map<string, Expression>, _methodName: string | undefined);
...
export declare class BooleanFunctionExpression extends BooleanExpression {
    readonly _expr: FunctionExpression;
    readonly expressionType: ExpressionType;
    constructor(_expr: FunctionExpression);
}
export declare class BooleanConstant extends BooleanExpression {
    readonly _expr: Constant;
    readonly expressionType: ExpressionType;
    constructor(_expr: Constant);
}
export declare class BooleanField extends BooleanExpression {
    readonly _expr: Field;
    readonly expressionType: ExpressionType;
    constructor(_expr: Field);
}
/**
 * @beta
...
export declare function _map(elements: Record<string, unknown>, methodName: string | undefined): FunctionExpression;
/**
 * Internal use only
 ...
 * @param plainObject
 */
export declare function _mapValue(plainObject: Record<string, unknown>): MapValue;
/**
 * @beta
 *
...
export declare function _array(elements: unknown[], methodName: string | undefined): FunctionExpression;
/**
 * @beta
 *
...
export declare function isSelectable(val: unknown): val is Selectable;
export declare function isOrdering(val: unknown): val is Ordering;
export declare function isAliasedAggregate(val: unknown): val is AliasedAggregate;
export declare function isExpr(val: unknown): val is Expression;
export declare function isBooleanExpr(val: unknown): val is BooleanExpression;
export declare function isField(val: unknown): val is Field;
export declare function toField(value: string | Field): Field;
