...
import { _ as a, a as o, F as h, b as c, c as u, d as l, O as _, e as d, f, g, h as m, i as p, j as w, q as y, k as P, l as D, m as b, P as v, n as k, o as O, p as S, r as C, s as x, C as j, t as z, u as tt, D as et, v as st, S as it, w as rt, x as nt, y as ot, z as ht, A as ct } from "./common-e4bd875c.browser.js";
 ...
 */ function getAggregate(t, e) {
    const s = d(t.firestore, h), i = f(s), r = g(e, ((t, e) => new __PRIVATE_AggregateImpl(e, t.aggregateType, t._internalFieldPath)));
    // Run the aggregation and convert the results
    return m(i, t._query, r).then((e => function __PRIVATE_convertToAggregateQuerySnapshot(t, e, s) {
        const i = new p(t), r = new AggregateQuerySnapshot(e, i, s);
        return r;
    }
    /**
 ...
 */ class WriteBatch {
    ...
    set(t, e, s) {
        ...
        const i = __PRIVATE_validateReference(t, this._firestore), r = D(i.converter, e, s), a = b(this._dataReader, "WriteBatch.set", i._key, r, null !== i.converter, s);
        return this._mutations.push(a.toMutation(i._key, v.none())), this;
    }
    update(t, e, s, ...i) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let a;
        return a = "string" == typeof (e = lt(e)) || e instanceof k ? O(this._dataReader, "WriteBatch.update", r._key, e, s, i) : S(this._dataReader, "WriteBatch.update", r._key, e), 
        this._mutations.push(a.toMutation(r._key, v.exists(!0))), this;
    }
    /**
...
class __PRIVATE_AsyncQueueImpl {
    constructor(t = Promise.resolve()) {
        ...
        this.L = () => {
            const t = getDocument();
            t && a(ft, "Visibility state changed to " + t.visibilityState), this.P.T();
        }, this.W = t;
        const e = getDocument();
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
                                a(ft, "Operation failed with retryable error: " + t);
            }
            this.k.length > 0 && 
 ...
 */ class Transaction {
    ...
    set(t, e, s) {
        const i = __PRIVATE_validateReference(t, this._firestore), r = D(i.converter, e, s), a = b(this._dataReader, "Transaction.set", i._key, r, null !== i.converter, s);
    ...
    update(t, e, s, ...i) {
        ...
        // performing validation.
                let a;
        return a = "string" == typeof (e = lt(e)) || e instanceof k ? O(this._dataReader, "Transaction.update", r._key, e, s, i) : S(this._dataReader, "Transaction.update", r._key, e), 
 ...
 */ !function __PRIVATE_registerFirestore() {
    o(`${i}_lite`), t(new r("firestore/lite", ((t, {instanceIdentifier: e, options: s}) => {
        const i = t.getProvider("app").getImmediate(), r = new h(new c(t.getProvider("auth-internal")), new u(i, t.getProvider("app-check-internal")), l(i, e), i);
