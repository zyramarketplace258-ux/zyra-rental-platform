import { FirebaseError as e, isCloudWorkstation as t, getDefaultEmulatorHostnameAndPort as r, pingServer as n, updateEmulatorBanner as i, deepEqual as s, createMockUserToken as o, getModularInstance as a } from "@firebase/util";

import { Logger as u, LogLevel as _ } from "@firebase/logger";

import { Integer as c } from "@firebase/webchannel-wrapper/bloom-blob";

import { _isFirebaseServerApp as l, _getProvider, getApp as h, _removeServiceInstance as f } from "@firebase/app";
 ...
 * limitations under the License.
 */
const m = new u("@firebase/firestore");
...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, t) {
        this.m = t, this.appCheck = null, this.P = null, l(e) && e.settings.appCheckToken && (this.P = e.settings.appCheckToken), 
        t.onInit((e => {
            this.appCheck = e;
        }));
    }
 ...
 */ class BasePath {
    ...
    static extractNumericId(e) {
        return c.fromString(e.substring(4, e.length - 2));
    }
}
 ...
 */ const U = 1048576, M = "firestore.googleapis.com", x = !0;
...
function getFirestore(e, t) {
    const n = "object" == typeof e ? e : h(), i = "string" == typeof e ? e : t || "(default)", s = _getProvider(n, "firestore/lite").getImmediate({
        identifier: i
    });
    if (!s._initialized) {
        const e = r("firestore");
 ...
 */ function connectFirestoreEmulator(e, r, a, u = {}) {
    ...
    _ && (n(`https://${h}`), i("Firestore", !0)), c.host !== M && c.host !== h && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
    const f = {
        ...c,
        host: h,
        ssl: _,
 ...
 */ function terminate(e) {
    return e = __PRIVATE_cast(e, Firestore), f(e.app, "firestore/lite"), e._delete();
}
...
function collection(e, t, ...r) {
    if (e = a(e), __PRIVATE_validateNonEmptyArgument("collection", "path", t), e instanceof Firestore) {
 ...
 */ function refEqual(e, t) {
    return e = a(e), t = a(t), (e instanceof DocumentReference || e instanceof CollectionReference) && (t instanceof DocumentReference || t instanceof CollectionReference) && (e.firestore === t.firestore && e.path === t.path && e.converter === t.converter);
}
 ...
 */ function queryEqual(e, t) {
    return e = a(e), t = a(t), e instanceof Query && t instanceof Query && (e.firestore === t.firestore && __PRIVATE_queryEquals(e._query, t._query) && e.converter === t.converter);
}
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayUnionFieldValueImpl && s(this.G, e.G);
    }
}
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayRemoveFieldValueImpl && s(this.G, e.G);
    }
}
 ...
 */ function __PRIVATE_parseData(e, t) {
    ...
    // from firestore-exp.
    e = a(e))) return __PRIVATE_validatePlainObject("Unsupported field value:", t, e), 
 ...
 */ function __PRIVATE_fieldPathFromArgument(e, t, r) {
    ...
    // FieldPath.
    t = a(t)) instanceof FieldPath) return t._internalPath;
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(e, t, r, n) {
    if (r[0] = a(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(e, t, r, n, i) {
...
function updateDoc(e, t, r, ...n) {
    ...
    // performing validation.
        let s;
    s = "string" == typeof (t = a(t)) || t instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(i, "updateDoc", e._key, t, r, n) : __PRIVATE_parseUpdateData(i, "updateDoc", e._key, t);
