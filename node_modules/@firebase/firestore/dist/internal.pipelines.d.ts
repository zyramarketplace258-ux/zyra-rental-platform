...
declare class CollectionReference<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> extends Query<AppModelType, DbModelType> {
    ...
    /** @hideconstructor */
    constructor(firestore: Firestore_2, converter: FirestoreDataConverter_2<AppModelType, DbModelType> | null, _path: ResourcePath);
...
export declare class DocumentReference<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> {
     ...
     * If provided, the `FirestoreDataConverter` associated with this instance.
     */
    converter: FirestoreDataConverter_2<AppModelType, DbModelType> | null, _key: DocumentKey);
     ...
     * {@link FirestoreError} if an error occurs.
     */
    static fromJSON(firestore: Firestore_2, json: object): DocumentReference;
    /**
     * Builds a `DocumentReference` instance from a JSON object created by
     * {@link DocumentReference.toJSON}.
     *
     ...
     * {@link FirestoreError} if an error occurs.
     */
    static fromJSON<NewAppModelType = DocumentData, NewDbModelType extends DocumentData = DocumentData>(firestore: Firestore_2, json: object, converter: FirestoreDataConverter_2<NewAppModelType, NewDbModelType>): DocumentReference<NewAppModelType, NewDbModelType>;
}
...
declare class DocumentSnapshot<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> {
    ...
    constructor(_firestore: Firestore_2, _userDataWriter: AbstractUserDataWriter, _key: DocumentKey, _document: Document_2 | null, _converter: UntypedFirestoreDataConverter<AppModelType, DbModelType> | null);
 ...
 * explicitly verify a document's existence.
 */
declare class DocumentSnapshot_2<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> extends DocumentSnapshot<AppModelType, DbModelType> {
    ...
    /** @hideconstructor protected */
    constructor(_firestore: Firestore, userDataWriter: AbstractUserDataWriter, key: DocumentKey, document: Document_2 | null, metadata: SnapshotMetadata, converter: UntypedFirestoreDataConverter<AppModelType, DbModelType> | null);
    /**
 ...
 */
export declare function execute(pipeline: Pipeline_2): Promise<PipelineSnapshot>;
 ...
 */
export declare function _internalPipelineToExecutePipelineRequestProto(pipeline: Pipeline_2): any;
 ...
 * ```
 */
declare class Pipeline_2 implements ProtoSerializable<Pipeline_3> {
    /**
     * @internal
     * @private
     */
     ...
     */
    addFields(field: Selectable, ...additionalFields: Selectable[]): Pipeline_2;
    /**
     * @beta
     * Adds new fields to outputs from previous stages.
     *
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    addFields(options: AddFieldsStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    removeFields(fieldValue: Field | string, ...additionalFields: Array<Field | string>): Pipeline_2;
    /**
     * @beta
     * Remove fields from outputs of previous stages.
     *
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    removeFields(options: RemoveFieldsStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    select(selection: Selectable | string, ...additionalSelections: Array<Selectable | string>): Pipeline_2;
    /**
     * @beta
     * Selects or creates a set of fields from the outputs of previous stages.
     *
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    select(options: SelectStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    where(condition: BooleanExpression): Pipeline_2;
    /**
     * @beta
     * Filters the documents from previous stages to only include those matching the specified {@link
     * @firebase/firestore/pipelines#BooleanExpression}.
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    where(options: WhereStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    offset(offset: number): Pipeline_2;
    /**
     * @beta
     * Skips the first `offset` number of documents from the results of previous stages.
     *
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    offset(options: OffsetStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    limit(options: LimitStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     */
    distinct(group: string | Selectable, ...additionalGroups: Array<string | Selectable>): Pipeline_2;
    /**
     * @beta
     * Returns a set of distinct values from the inputs to this stage.
     *
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    distinct(options: DistinctStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new Pipeline object with this stage appended to the stage list.
     */
    aggregate(accumulator: AliasedAggregate, ...additionalAccumulators: AliasedAggregate[]): Pipeline_2;
    /**
     * @beta
     ...
     * list.
     */
    aggregate(options: AggregateStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    findNearest(options: FindNearestStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    sort(ordering: Ordering, ...additionalOrderings: Ordering[]): Pipeline_2;
    /**
     * @beta
     * Sorts the documents from previous stages based on one or more {@link @firebase/firestore/pipelines#Ordering} criteria.
     *
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    sort(options: SortStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    replaceWith(fieldName: string): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    replaceWith(expr: Expression): Pipeline_2;
    /**
     * @beta
     * Fully overwrites all fields in a document with those coming from a map.
     *
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    replaceWith(options: ReplaceWithStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    sample(documents: number): Pipeline_2;
    /**
     * @beta
     * Performs a pseudo-random sampling of the documents from the previous stage.
     *
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    sample(options: SampleStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    union(other: Pipeline_2): Pipeline_2;
    /**
     * @beta
     * Performs union of all documents from two pipelines, including duplicates.
     *
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    union(options: UnionStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    unnest(selectable: Selectable, indexField?: string): Pipeline_2;
    /**
     * @beta
     * Produces a document for each element in an input array.
     *
     ...
     * @returns A new {@link @firebase/firestore/pipelines#Pipeline} object with this stage appended to the stage list.
     */
    unnest(options: UnnestStageOptions): Pipeline_2;
    /**
     * @beta
     ...
     * @private
     */
    _toProto(jsonProtoSerializer: JsonProtoSerializer): Pipeline_3;
    private _addStage;
    /**
     * @internal
     * @private
     ...
     * @protected
     */
    protected newPipeline(db: Firestore_2, userDataReader: UserDataReader, userDataWriter: AbstractUserDataWriter, stages: Stage[]): Pipeline_2;
}

declare type Pipeline_3 = firestoreV1ApiClientInterfaces.Pipeline;
...
export declare class PipelineSnapshot {
    ...
    constructor(pipeline: Pipeline_2, results: PipelineResult[], executionTime?: Timestamp);
    /**
...
export declare class PipelineSource<PipelineType> {
     ...
     * @throws `FirestoreError` Thrown if any of the provided DocumentReferences target a different project or database than the pipeline.
     */
    createFrom(query: Query): Pipeline_2;
 ...
 * 'undefined'.
 */
export declare class QueryDocumentSnapshot<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> extends DocumentSnapshot_2<AppModelType, DbModelType> {
    /**
 ...
 * 'undefined'.
 */
declare class QueryDocumentSnapshot_2<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> extends DocumentSnapshot<AppModelType, DbModelType> {
    /**
     * Retrieves all fields in the document as an `Object`.
     *
     * @override
