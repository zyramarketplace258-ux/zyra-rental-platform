import { O as e, av as t, aw as n, ax as r, g as s, s as i, ay as o, az as a, af as u, j as _, aA as l, aB as c, aq as p, am as E, aC as f, aD as T, aE as d, M as x, aF as h, aG as A, w as P, aH as V, aI as I, aJ as R, aK as g, aL as m, I as w, C as $, J as v, aM as D, f as F, aN as O, aO as y, F as U, i as b, k as S } from "./common-c78a0fa7.rn.esm.js";
 ...
 */ class OptionsUtil {
    ...
    _getKnownOptions(s, i) {
        ...
        // SERIALIZE KNOWN OPTIONS
            ...
            if (e in s) {
                const u = s[e];
                let _;
                if (a.nestedOptions && t(u)) {
                    _ = {
                        mapValue: {
                            fields: new OptionsUtil(a.nestedOptions).getOptionsProto(i, u)
                        }
                    };
                } else u && (_ = n(u, i) ?? void 0);
                _ && o.set(r.fromServerFormat(a.serverName), _);
            }
        }
        return o;
    }
    getOptionsProto(e, t, i) {
        ...
        // APPLY OPTIONS OVERRIDES
                if (i) {
            const t = new Map(s(i, ((t, s) => [ r.fromServerFormat(s), void 0 !== t ? n(t, e) : null ])));
            o.setAll(t);
        }
...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_isFirestoreValue(e) {
    return "object" == typeof e && null !== e && !!("nullValue" in e && (null === e.nullValue || "NULL_VALUE" === e.nullValue) || "booleanValue" in e && (null === e.booleanValue || "boolean" == typeof e.booleanValue) || "integerValue" in e && (null === e.integerValue || "number" == typeof e.integerValue || "string" == typeof e.integerValue) || "doubleValue" in e && (null === e.doubleValue || "number" == typeof e.doubleValue) || "timestampValue" in e && (null === e.timestampValue || function __PRIVATE_isITimestamp(e) {
        ...
        return "object" == typeof e && null !== e && !(!("fields" in e) || null !== e.fields && !t(e.fields));
 ...
 */ function __PRIVATE_valueToDefaultExpr$1(e) {
    let n;
    return e instanceof Expression ? e : (n = t(e) ? __PRIVATE__map(e) : e instanceof Array ? array(e) : __PRIVATE__constant(e, void 0), 
    n);
}
 ...
 */ function __PRIVATE_vectorToExpr$1(e) {
    ...
    if (e instanceof p) return constant(e);
    if (Array.isArray(e)) return constant(E(e));
 ...
 */ class Expression {
     ...
     */    asBoolean() {
        ...
        throw new i("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
    }
    subtract(e) {
    ...
    timestampTruncate(e, t) {
        const n = [ this, __PRIVATE_valueToDefaultExpr$1(o(e) ? e.toLowerCase() : e) ];
...
function _field(e, t) {
    return new Field("string" == typeof e ? a === e ? u()._internalPath : _("field", e) : e._internalPath, t);
}
 ...
 */ class Constant extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return l(void 0 !== this._protoValue, 237), this._protoValue;
    }
    /**
     * @private
     * @internal
     */    _readUserData(e) {
        e = this._methodName ? e.contextWith({
            methodName: this._methodName
        }) : e, __PRIVATE_isFirestoreValue(this._protoValue) || (this._protoValue = n(this.value, e));
    }
}
...
function timestampTruncate(e, t, n) {
    const r = o(t) ? __PRIVATE_valueToDefaultExpr$1(t.toLowerCase()) : t;
...
function __PRIVATE_isSelectable(e) {
    const t = e;
    return t.selectable && o(t.alias) && __PRIVATE_isExpr(t.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const t = e;
    return o(t.alias) && t.aggregate instanceof AggregateFunction;
}
...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_toPipelineBooleanExpr(e) {
    ...
    } else if (e instanceof V) switch (e.op) {
...
function __PRIVATE_toPipeline(e, t) {
    let n;
    n = T(e) ? t.pipeline().collectionGroup(e.collectionGroup) : d(e) ? t.pipeline().documents([ x(t, e.path.canonicalString()) ]) : t.pipeline().collection(e.path.canonicalString());
    // filters
        for (const t of e.filters) n = n.where(__PRIVATE_toPipelineBooleanExpr(t));
    // orders
        const r = h(e), s = e.explicitOrderBy.map((e => field(e.field.canonicalString()).exists()));
    if (s.length > 0) {
 ...
 */ class __PRIVATE_Aggregate extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ f(e, this.accumulators), f(e, this.groups) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_FindNearest extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.field._toProto(e), this.vectorValue._toProto(e), c(this.distanceMeasure) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Sample extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ I(e, this.rate), c(this.mode) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
 ...
 */ class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), c(__PRIVATE_Replace.T) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, t) {
    return g(e) ? e._readUserData(t) : Array.isArray(e) ? e.forEach((e => e._readUserData(t))) : e.forEach((e => e._readUserData(t))), 
    e;
}
 ...
 */ class PipelineSource {
    ...
    collection(e) {
        ...
        const t = o(e) || m(e) ? {} : e, n = o(e) || m(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        m(n) && this._validateReference(n);
        // Convert user land convenience types to internal types
                const r = o(n) ? n : n.path, s = new __PRIVATE_CollectionSource(r, t), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "collection");
        // Create stage object
    ...
    documents(e) {
        ...
        n.filter((e => e instanceof w)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const r = n.map((e => o(e) ? e : e.path)), s = new __PRIVATE_DocumentsSource(r, t), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "documents");
        // Create stage object
                // Add stage to the pipeline
        return s._readUserData(i), this._createPipeline([ s ]);
    }
 ...
 */ function __PRIVATE_selectablesToMap(e) {
    ...
    for (const n of e) {
        ...
        r = n.expr) : P(21273, {
            selectable: n
        }), void 0 !== t.get(e)) throw new i("invalid-argument", `Duplicate alias or field '${e}'`);
        t.set(e, r);
    }
    return t;
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(e) {
        ...
        if (e instanceof Expression) return e;
        n = t(e) ? map(e) : e instanceof Array ? array(e) : __PRIVATE__constant(e, void 0);
        return n;
    }
    /**
 * @license
...
class Pipeline {
    ...
    removeFields(e, ...t) {
        // Process argument union(s) from method overloads
        const n = __PRIVATE_isField(e) || o(e) ? {} : e, r = (__PRIVATE_isField(e) || o(e) ? [ e, ...t ] : e.fields).map((e => o(e) ? field(e) : e)), s = new __PRIVATE_RemoveFields(r, n);
        // Add stage to the pipeline
        // User data must be read in the context of the API method to
        // provide contextual errors
    ...
    select(e, ...t) {
        // Process argument union(s) from method overloads
        const n = __PRIVATE_isSelectable(e) || o(e) ? {} : e, r = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || o(e) ? [ e, ...t ] : e.selections), s = new __PRIVATE_Select(r, n), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "select");
        // Add stage to the pipeline
    ...
    distinct(e, ...t) {
        // Process argument union(s) from method overloads
        const n = o(e) || __PRIVATE_isSelectable(e) ? {} : e, r = __PRIVATE_selectablesToMap(o(e) || __PRIVATE_isSelectable(e) ? [ e, ...t ] : e.groups), s = new __PRIVATE_Distinct(r, n), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "distinct");
        // Add stage to the pipeline
        return s._readUserData(i), this._addStage(s);
    }
    aggregate(e, ...t) {
        ...
        const n = __PRIVATE_isAliasedAggregate(e) ? {} : e, r = __PRIVATE_isAliasedAggregate(e) ? [ e, ...t ] : e.accumulators, s = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], o = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, t) => {
                if (void 0 !== e.get(t.alias)) throw new i("invalid-argument", `Duplicate alias or field '${t.alias}'`);
 ...
 */ (r), a = __PRIVATE_selectablesToMap(s), u = new __PRIVATE_Aggregate(a, o, n), _ = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "aggregate");
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const t = o(e) || __PRIVATE_isExpr(e) ? {} : e, n = __PRIVATE_fieldOrExpression(o(e) || __PRIVATE_isExpr(e) ? e : e.map), r = new __PRIVATE_Replace(n, t), s = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "replaceWith");
        // Add stage to the pipeline
        return r._readUserData(s), this._addStage(r);
    }
    sample(e) {
 ...
 */ (e) ? ({other: n, ...t} = e) : (t = {}, n = e);
    ...
    unnest(e, t) {
        ...
        o(s) && (n.indexField = _field(s, "unnest"));
        // Create stage object
     ...
     */    rawStage(e, n, r) {
        // Convert user land convenience types to internal types
        const s = n.map((e => e instanceof Expression || e instanceof AggregateFunction ? e : t(e) ? function __PRIVATE__mapValue(e) {
            const t = new Map;
...
function execute(e) {
    const t = F(e._db), n = new O(e._db._databaseId, 
    ...
    return y(t, s).then((t => {
        ...
        const n = t.length > 0 ? t[0].executionTime?.toTimestamp() : void 0, r = t.filter((e => !!e.fields)).map((t => new PipelineResult(e._userDataWriter, t.fields, t.key?.path ? new w(e._db, null, t.key) : void 0, t.createTime?.toTimestamp(), t.updateTime?.toTimestamp())));
 ...
 * ```
 */ U.prototype.pipeline = function() {
    const e = new b(this), t = S(this);
...
//# sourceMappingURL=pipelines.rn.esm.js.map
