import { F as Firestore, f as __PRIVATE_newUserDataReader, H as __PRIVATE_ExpUserDataWriter, d as FirestoreError, b4 as __PRIVATE_isString, b5 as M, aT as documentId$1, i as __PRIVATE_fieldPathFromArgument, b6 as __PRIVATE_hardAssert, b7 as __PRIVATE_parseData, b8 as __PRIVATE_toStringValue, b9 as __PRIVATE_isCollectionReference, D as DocumentReference, C, av as CollectionReference, ba as __PRIVATE_isOptionalEqual, y as __PRIVATE_cast, z as ensureFirestoreConfigured, bb as UserDataReader, bc as __PRIVATE_firestoreClientExecutePipeline, bd as __PRIVATE_isPlainObject, aA as VectorValue, b2 as vector, u as __PRIVATE_isCollectionGroupQuery, be as __PRIVATE_isDocumentQuery$1, a6 as doc, q as __PRIVATE_queryNormalizedOrderBy, bf as OptionsUtil, a_ as refEqual, bg as __PRIVATE_isNumber$1, bh as __PRIVATE_StructuredPipelineOptions, bi as __PRIVATE_toMapValue, h as FieldFilter, U as fail, j as CompositeFilter, bj as toNumber, bk as __PRIVATE_toPipelineValue, bl as __PRIVATE_isUserData, bm as StructuredPipeline } from './common-3cb50c20.esm.js';
export { bn as _internalPipelineToExecutePipelineRequestProto } from './common-3cb50c20.esm.js';
import '@firebase/app';
 ...
 */ function __PRIVATE_valueToDefaultExpr$1(t) {
    let n;
    return t instanceof Expression ? t : (n = __PRIVATE_isPlainObject(t) ? __PRIVATE__map(t) : t instanceof Array ? array(t) : __PRIVATE__constant(t, void 0), 
    n);
}
 ...
 */ class Expression {
    ...
    timestampTruncate(e, t) {
        const r = [ this, __PRIVATE_valueToDefaultExpr$1(__PRIVATE_isString(e) ? e.toLowerCase() : e) ];
...
function _field(e, t) {
    return new Field("string" == typeof e ? M === e ? documentId$1()._internalPath : __PRIVATE_fieldPathFromArgument("field", e) : e._internalPath, t);
}
 ...
 */ class MapValue extends Expression {
    ...
    _toProto(e) {
        return __PRIVATE_toMapValue(e, this.i);
    }
}
...
function timestampTruncate(e, t, r) {
    const s = __PRIVATE_isString(t) ? __PRIVATE_valueToDefaultExpr$1(t.toLowerCase()) : t;
...
function __PRIVATE_toPipeline(e, t) {
    let n;
    n = __PRIVATE_isCollectionGroupQuery(e) ? t.pipeline().collectionGroup(e.collectionGroup) : __PRIVATE_isDocumentQuery$1(e) ? t.pipeline().documents([ doc(t, e.path.canonicalString()) ]) : t.pipeline().collection(e.path.canonicalString());
    // filters
 ...
 */ class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), __PRIVATE_toStringValue(__PRIVATE_Replace._) ]
        };
    }
    _readUserData(e) {
 ...
 */ class PipelineSource {
    ...
    _validateReference(e) {
        ...
        if (!n.isEqual(this.databaseId)) throw new FirestoreError(C.INVALID_ARGUMENT, `Invalid ${e instanceof CollectionReference ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
 ...
 */ function pipelineResultEqual(e, t) {
    return e === t || __PRIVATE_isOptionalEqual(e._ref, t._ref, refEqual) && __PRIVATE_isOptionalEqual(e._fields, t._fields, ((e, t) => e.isEqual(t)));
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(t) {
        ...
        n = __PRIVATE_isPlainObject(t) ? map(t) : t instanceof Array ? array(t) : __PRIVATE__constant(t, void 0);
        return n;
    }
    /**
 * @license
...
class Pipeline$1 {
    ...
    select(e, ...t) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isSelectable(e) || __PRIVATE_isString(e) ? {} : e, s = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || __PRIVATE_isString(e) ? [ e, ...t ] : e.selections), i = new __PRIVATE_Select(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "select");
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
    where(e) {
    ...
    offset(e) {
        // Process argument union(s) from method overloads
        let t, n;
        __PRIVATE_isNumber$1(e) ? (t = {}, n = e) : (t = e, n = e.offset);
        // Create stage object
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isNumber$1(e) ? {} : e, n = __PRIVATE_isNumber$1(e) ? e : e.limit, r = new __PRIVATE_Limit(n, t), s = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "limit");
        // Add stage to the pipeline
        return r._readUserData(s), this._addStage(r);
    }
    distinct(e, ...t) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? {} : e, s = __PRIVATE_selectablesToMap(__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? [ e, ...t ] : e.groups), i = new __PRIVATE_Distinct(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "distinct");
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
    aggregate(e, ...n) {
 ...
 */ (s), a = __PRIVATE_selectablesToMap(i), u = new __PRIVATE_Aggregate(a, o, r), _ = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "aggregate");
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? {} : e, r = __PRIVATE_fieldOrExpression(__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? e : e.map), s = new __PRIVATE_Replace(r, t), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "replaceWith");
        // Add stage to the pipeline
        return s._readUserData(i), this._addStage(s);
    }
    sample(e) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isNumber$1(e) ? {} : e;
        let n, r;
        __PRIVATE_isNumber$1(e) ? (n = e, r = "documents") : __PRIVATE_isNumber$1(e.documents) ? (n = e.documents, r = "documents") : (n = e.percentage, 
        r = "percent");
        // Create stage object
 ...
 */ (e) ? ({other: n, ...t} = e) : (t = {}, n = e);
     ...
     */    rawStage(t, n, r) {
        // Convert user land convenience types to internal types
        const s = n.map((t => t instanceof Expression || t instanceof AggregateFunction ? t : __PRIVATE_isPlainObject(t) ? function __PRIVATE__mapValue(e) {
            const t = new Map;
 ...
 */ function execute(e) {
    const t = e instanceof Pipeline$1 ? {
        pipeline: e
    } : e, {pipeline: n, rawOptions: r, ...s} = t, i = __PRIVATE_cast(n._db, Firestore), o = ensureFirestoreConfigured(i), a = new UserDataReader(i._databaseId, 
    /* ignoreUndefinedProperties */ !0).createContext(3 /* UserDataSource.Argument */ , "execute"), u = new __PRIVATE_StructuredPipelineOptions(s, r);
    u._readUserData(a);
    const _ = new StructuredPipeline(n, u);
    return __PRIVATE_firestoreClientExecutePipeline(o, _).then((e => {
        // Get the execution time from the first result.
        // firestoreClientExecutePipeline returns at least one PipelineStreamElement
        // even if the returned document set is empty.
        const t = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(n._userDataWriter, e.fields, e.key?.path ? new DocumentReference(i, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
...
Firestore.prototype.pipeline = function() {
    ...
    return new PipelineSource(this._databaseId, e, (t => new Pipeline(this, e, new __PRIVATE_ExpUserDataWriter(this), t)));
};
