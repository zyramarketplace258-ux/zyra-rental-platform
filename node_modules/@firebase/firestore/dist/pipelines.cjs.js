...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_isFirestoreValue(t) {
    return "object" == typeof t && null !== t && !!("nullValue" in t && (null === t.nullValue || "NULL_VALUE" === t.nullValue) || "booleanValue" in t && (null === t.booleanValue || "boolean" == typeof t.booleanValue) || "integerValue" in t && (null === t.integerValue || "number" == typeof t.integerValue || "string" == typeof t.integerValue) || "doubleValue" in t && (null === t.doubleValue || "number" == typeof t.doubleValue) || "timestampValue" in t && (null === t.timestampValue || function __PRIVATE_isITimestamp(e) {
        ...
        return "object" == typeof t && null !== t && !(!("fields" in t) || null !== t.fields && !common804201ea.__PRIVATE_isPlainObject(t.fields));
 ...
 */ function __PRIVATE_valueToDefaultExpr$1(t) {
    let n;
    return t instanceof Expression ? t : (n = common804201ea.__PRIVATE_isPlainObject(t) ? __PRIVATE__map(t) : t instanceof Array ? array(t) : __PRIVATE__constant(t, void 0), 
    n);
}
 ...
 */ function __PRIVATE_vectorToExpr$1(e) {
    ...
    if (e instanceof common804201ea.VectorValue) return constant(e);
    if (Array.isArray(e)) return constant(common804201ea.vector(e));
 ...
 */ function __PRIVATE_fieldOrExpression$1(e) {
    if (common804201ea.__PRIVATE_isString(e)) {
        return field(e);
    }
 ...
 */ class Expression {
     ...
     */    asBoolean() {
        ...
        throw new common804201ea.FirestoreError("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
    }
    subtract(e) {
    ...
    timestampTruncate(e, t) {
        const r = [ this, __PRIVATE_valueToDefaultExpr$1(common804201ea.__PRIVATE_isString(e) ? e.toLowerCase() : e) ];
...
function _field(e, t) {
    return new Field("string" == typeof e ? common804201ea.M === e ? common804201ea.documentId()._internalPath : common804201ea.__PRIVATE_fieldPathFromArgument("field", e) : e._internalPath, t);
}
 ...
 */ class Constant extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return common804201ea.__PRIVATE_hardAssert(void 0 !== this._protoValue, 237), this._protoValue;
    }
    /**
     * @private
     * @internal
     */    _readUserData(e) {
        e = this._methodName ? e.contextWith({
            methodName: this._methodName
        }) : e, __PRIVATE_isFirestoreValue(this._protoValue) || (this._protoValue = common804201ea.__PRIVATE_parseData(this.value, e));
    }
}
 ...
 */ class MapValue extends Expression {
    ...
    _toProto(e) {
        return common804201ea.__PRIVATE_toMapValue(e, this.i);
    }
}
...
function timestampTruncate(e, t, r) {
    const s = common804201ea.__PRIVATE_isString(t) ? __PRIVATE_valueToDefaultExpr$1(t.toLowerCase()) : t;
 ...
 */ class Ordering {
     ...
     */    _toProto(e) {
        return {
            mapValue: {
                fields: {
                    direction: common804201ea.__PRIVATE_toStringValue(this.direction),
...
function __PRIVATE_isSelectable(e) {
    const t = e;
    return t.selectable && common804201ea.__PRIVATE_isString(t.alias) && __PRIVATE_isExpr(t.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const t = e;
    return common804201ea.__PRIVATE_isString(t.alias) && t.aggregate instanceof AggregateFunction;
}
...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_toPipelineBooleanExpr(e) {
    if (e instanceof common804201ea.FieldFilter) {
        ...
        // Comparison filters
          ...
          default:
            common804201ea.fail(36935);
        }
    } else if (e instanceof common804201ea.CompositeFilter) switch (e.op) {
...
function __PRIVATE_toPipeline(e, t) {
    let n;
    n = common804201ea.__PRIVATE_isCollectionGroupQuery(e) ? t.pipeline().collectionGroup(e.collectionGroup) : common804201ea.__PRIVATE_isDocumentQuery$1(e) ? t.pipeline().documents([ common804201ea.doc(t, e.path.canonicalString()) ]) : t.pipeline().collection(e.path.canonicalString());
    // filters
        for (const t of e.filters) n = n.where(__PRIVATE_toPipelineBooleanExpr(t));
    // orders
        const r = common804201ea.__PRIVATE_queryNormalizedOrderBy(e), s = e.explicitOrderBy.map((e => field(e.field.canonicalString()).exists()));
    if (s.length > 0) {
 ...
 */ class __PRIVATE_AddFields extends Stage {
    ...
    get _optionsUtil() {
        return new common804201ea.OptionsUtil({});
    }
    constructor(e, t) {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.__PRIVATE_toMapValue(e, this.fields) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Aggregate extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.__PRIVATE_toMapValue(e, this.accumulators), common804201ea.__PRIVATE_toMapValue(e, this.groups) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Distinct extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.__PRIVATE_toMapValue(e, this.groups) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_FindNearest extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.field._toProto(e), this.vectorValue._toProto(e), common804201ea.__PRIVATE_toStringValue(this.distanceMeasure) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Limit extends Stage {
    ...
    constructor(e, t) {
        common804201ea.__PRIVATE_hardAssert(!isNaN(e) && e !== 1 / 0 && e !== -1 / 0, 34860), super(t), this.limit = e;
    }
    /**
     * @internal
     * @private
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.toNumber(e, this.limit) ]
        };
    }
}
 ...
 */ class __PRIVATE_Offset extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.toNumber(e, this.offset) ]
        };
    }
}
 ...
 */ class __PRIVATE_Select extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.__PRIVATE_toMapValue(e, this.selections) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Sample extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.toNumber(e, this.rate), common804201ea.__PRIVATE_toStringValue(this.mode) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
 ...
 */ class __PRIVATE_Union extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common804201ea.__PRIVATE_toPipelineValue(this.other._toProto(e)) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
 ...
 */ class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), common804201ea.__PRIVATE_toStringValue(__PRIVATE_Replace._) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, t) {
    return common804201ea.__PRIVATE_isUserData(e) ? e._readUserData(t) : Array.isArray(e) ? e.forEach((e => e._readUserData(t))) : e.forEach((e => e._readUserData(t))), 
    e;
}
 ...
 */ class PipelineSource {
    ...
    collection(e) {
        ...
        const t = common804201ea.__PRIVATE_isString(e) || common804201ea.__PRIVATE_isCollectionReference(e) ? {} : e, r = common804201ea.__PRIVATE_isString(e) || common804201ea.__PRIVATE_isCollectionReference(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        common804201ea.__PRIVATE_isCollectionReference(r) && this._validateReference(r);
        // Convert user land convenience types to internal types
                const s = common804201ea.__PRIVATE_isString(r) ? r : r.path, i = new __PRIVATE_CollectionSource(s, t), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "collection");
        // Create stage object
    ...
    collectionGroup(e) {
        // Process argument union(s) from method overloads
        let t, r;
        common804201ea.__PRIVATE_isString(e) ? (t = e, r = {}) : ({collectionId: t, ...r} = e);
        // Create stage object
    ...
    documents(e) {
        ...
        r.filter((e => e instanceof common804201ea.DocumentReference)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const s = r.map((e => common804201ea.__PRIVATE_isString(e) ? e : e.path)), i = new __PRIVATE_DocumentsSource(s, t), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "documents");
        // Create stage object
                // Add stage to the pipeline
        return i._readUserData(o), this._createPipeline([ i ]);
    }
    ...
    _validateReference(e) {
        ...
        if (!n.isEqual(this.databaseId)) throw new common804201ea.FirestoreError(common804201ea.C.INVALID_ARGUMENT, `Invalid ${e instanceof common804201ea.CollectionReference ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
 ...
 */ class PipelineResult {
    ...
    get(e) {
        ...
        const t = this._fields.field(common804201ea.__PRIVATE_fieldPathFromArgument("DocumentSnapshot.get", e));
 ...
 */ function pipelineResultEqual(e, t) {
    return e === t || common804201ea.__PRIVATE_isOptionalEqual(e._ref, t._ref, common804201ea.refEqual) && common804201ea.__PRIVATE_isOptionalEqual(e._fields, t._fields, ((e, t) => e.isEqual(t)));
}
 ...
 */ function __PRIVATE_selectablesToMap(e) {
    ...
    for (const r of e) {
        ...
        s = r.expr) : common804201ea.fail(21273, {
            selectable: r
        }), void 0 !== n.get(e)) throw new common804201ea.FirestoreError("invalid-argument", `Duplicate alias or field '${e}'`);
        n.set(e, s);
    }
    return n;
}
...
function __PRIVATE_fieldOrExpression(t) {
    if (common804201ea.__PRIVATE_isString(t)) {
        return field(t);
    }
    /**
 * Converts a value to an Expression, Returning either a Constant, MapFunction,
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(t) {
        ...
        n = common804201ea.__PRIVATE_isPlainObject(t) ? map(t) : t instanceof Array ? array(t) : __PRIVATE__constant(t, void 0);
        return n;
    }
    /**
 * @license
...
class Pipeline$1 {
    ...
    removeFields(e, ...t) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isField(e) || common804201ea.__PRIVATE_isString(e) ? {} : e, s = (__PRIVATE_isField(e) || common804201ea.__PRIVATE_isString(e) ? [ e, ...t ] : e.fields).map((e => common804201ea.__PRIVATE_isString(e) ? field(e) : e)), i = new __PRIVATE_RemoveFields(s, r);
        // Add stage to the pipeline
        // User data must be read in the context of the API method to
        // provide contextual errors
    ...
    select(e, ...t) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isSelectable(e) || common804201ea.__PRIVATE_isString(e) ? {} : e, s = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || common804201ea.__PRIVATE_isString(e) ? [ e, ...t ] : e.selections), i = new __PRIVATE_Select(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "select");
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
    where(e) {
    ...
    offset(e) {
        // Process argument union(s) from method overloads
        let t, n;
        common804201ea.__PRIVATE_isNumber$1(e) ? (t = {}, n = e) : (t = e, n = e.offset);
        // Create stage object
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const t = common804201ea.__PRIVATE_isNumber$1(e) ? {} : e, n = common804201ea.__PRIVATE_isNumber$1(e) ? e : e.limit, r = new __PRIVATE_Limit(n, t), s = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "limit");
        // Add stage to the pipeline
        return r._readUserData(s), this._addStage(r);
    }
    distinct(e, ...t) {
        // Process argument union(s) from method overloads
        const r = common804201ea.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? {} : e, s = __PRIVATE_selectablesToMap(common804201ea.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? [ e, ...t ] : e.groups), i = new __PRIVATE_Distinct(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "distinct");
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
    aggregate(e, ...n) {
        ...
        const r = __PRIVATE_isAliasedAggregate(e) ? {} : e, s = __PRIVATE_isAliasedAggregate(e) ? [ e, ...n ] : e.accumulators, i = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], o = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, n) => {
                if (void 0 !== e.get(n.alias)) throw new common804201ea.FirestoreError("invalid-argument", `Duplicate alias or field '${n.alias}'`);
 ...
 */ (s), a = __PRIVATE_selectablesToMap(i), u = new __PRIVATE_Aggregate(a, o, r), _ = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "aggregate");
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const t = common804201ea.__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? {} : e, r = __PRIVATE_fieldOrExpression(common804201ea.__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? e : e.map), s = new __PRIVATE_Replace(r, t), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "replaceWith");
        // Add stage to the pipeline
        return s._readUserData(i), this._addStage(s);
    }
    sample(e) {
        // Process argument union(s) from method overloads
        const t = common804201ea.__PRIVATE_isNumber$1(e) ? {} : e;
        let n, r;
        common804201ea.__PRIVATE_isNumber$1(e) ? (n = e, r = "documents") : common804201ea.__PRIVATE_isNumber$1(e.documents) ? (n = e.documents, r = "documents") : (n = e.percentage, 
        r = "percent");
        // Create stage object
 ...
 */ (e) ? ({other: n, ...t} = e) : (t = {}, n = e);
    ...
    unnest(e, t) {
        ...
        common804201ea.__PRIVATE_isString(i) && (r.indexField = _field(i, "unnest"));
        // Create stage object
     ...
     */    rawStage(t, n, r) {
        // Convert user land convenience types to internal types
        const s = n.map((t => t instanceof Expression || t instanceof AggregateFunction ? t : common804201ea.__PRIVATE_isPlainObject(t) ? function __PRIVATE__mapValue(e) {
            const t = new Map;
 ...
 */ function execute(e) {
    const t = e instanceof Pipeline$1 ? {
        pipeline: e
    } : e, {pipeline: n, rawOptions: r, ...s} = t, i = common804201ea.__PRIVATE_cast(n._db, common804201ea.Firestore), o = common804201ea.ensureFirestoreConfigured(i), a = new common804201ea.UserDataReader(i._databaseId, 
    /* ignoreUndefinedProperties */ !0).createContext(3 /* UserDataSource.Argument */ , "execute"), u = new common804201ea.__PRIVATE_StructuredPipelineOptions(s, r);
    u._readUserData(a);
    const _ = new common804201ea.StructuredPipeline(n, u);
    return common804201ea.__PRIVATE_firestoreClientExecutePipeline(o, _).then((e => {
        // Get the execution time from the first result.
        // firestoreClientExecutePipeline returns at least one PipelineStreamElement
        // even if the returned document set is empty.
        const t = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(n._userDataWriter, e.fields, e.key?.path ? new common804201ea.DocumentReference(i, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
...
common804201ea.Firestore.prototype.pipeline = function() {
    const e = common804201ea.__PRIVATE_newUserDataReader(this);
    return new PipelineSource(this._databaseId, e, (t => new Pipeline(this, e, new common804201ea.__PRIVATE_ExpUserDataWriter(this), t)));
};

exports._internalPipelineToExecutePipelineRequestProto = common804201ea._internalPipelineToExecutePipelineRequestProto;
